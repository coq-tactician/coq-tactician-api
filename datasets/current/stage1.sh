...
eval $(opam env --root=./opam-root --set-root)
time opam install --keep-build-dir --yes --assume-depext ./coq-tactician-reinforce/ lwt.4.5.0 ocaml-base-compiler.4.09.1 js_of_ocaml.3.9.0 menhir.20190924 --fake
tactician inject
